require([
    ...
    "esri/core/Accessor",
              ...
              TimeSlider, Slider, Legend, LayerList, Fullscreen,
...
const NEEDLE_LENGTH = am4core.percent(70);
  ...
  //////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////
  // Segmentation number slider
  var sliderContainer = document.getElementById("sliderContainer");
  const segmentSlider = new Slider({
    container: "segmentSlider",
    min: 1,
    max: 2000,
    steps: 1,
    values: [1, 2000],
  ...
  view.ui.add("infoDiv", "bottom_right");
  segmentSlider.on(["thumb-drag", "thumb-change", "segment-drag"], updateSegment);
  
  function updateSegment() {
        // Reset graphics layer
        graphicsLayer.removeAll();

    segmentValue = segmentSlider.values[0];
        // Run based on selected Section values
        const selectValue = sectionSelect.value;
        tbmTunnelLayer.definitionExpression = selectValue === "PO" ? "Section = 'PO'" : "Section = 'Remaining'";
    

    var query = tbmTunnelLayer.createQuery();
    query.where = "SegmentNo <= " + segmentValue;
